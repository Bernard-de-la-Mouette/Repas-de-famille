...
const WEEKS_DEFAULT = {
  A: { label: 'Semaine A', days: [
    day('Lundi', 'poulet-citron-riz-haricots', 'omelette-salade'),
    day('Mardi', 'restes', 'pates-courgettes-creme-vegetale'),
    day('Mercredi', 'oeufs-brouilles-riz-legumes', 'wrap-oeuf-carotte-concombre'),
    day('Jeudi', 'cabillaud-pommes-de-terre-carottes', 'restes'),
    day('Vendredi', 'hachis-parmentier-vegetalise', 'restes'),
    day('Samedi', 'pizza-maison', 'thon-riz-concombre-carottes'),
    day('Dimanche', 'quiche-courgette-jambon', 'restes'),
  ]},
  B: { label: 'Semaine B', days: [
    day('Lundi', 'emince-dinde-pates-creme', 'restes'),
    day('Mardi', 'lentilles-corail-riz-carottes', 'omelette-salade'),
    day('Mercredi', 'sandwich-chaud', 'gratin-poulet-pommes-de-terre'),
    day('Jeudi', 'restes', 'galettes-thon-pomme-de-terre'),
    day('Vendredi', 'saumon-pommes-de-terre-courgettes', 'restes'),
    day('Samedi', 'steak-pates', 'tartines-chaudes-jambon-courgette'),
    day('Dimanche', 'poulet-four', 'restes'),
  ]},
  C: { label: 'Semaine C', days: [
    day('Lundi', 'riz-saute-poulet', 'restes'),
    day('Mardi', 'frittata-pommes-de-terre-courgettes', 'omelette-salade'),
    day('Mercredi', 'pates-thon', 'wrap-poulet'),
    day('Jeudi', 'boulettes-boeuf-riz-carottes', 'restes'),
    day('Vendredi', 'poisson-riz', 'restes'),
    day('Samedi', 'saucisse-puree', 'galettes-pommes-de-terre-carottes'),
    day('Dimanche', 'pizza-maison', 'thon-riz-concombre-carottes'),
  ]},
  D: { label: 'Semaine D', days: [
    day('Lundi', 'pates-creme-poulet', 'restes'),
    day('Mardi', 'steak-pates', 'omelette-salade'),
    day('Mercredi', 'riz-oeufs-legumes', 'sandwich-chaud'),
    day('Jeudi', 'pates-bolo', 'restes'),
    day('Vendredi', 'poulet-four', 'restes'),
    day('Samedi', 'pizza-maison', 'poelee-legumes-oeufs'),
    day('Dimanche', 'saucisse-puree', 'restes'),
  ]},
};
